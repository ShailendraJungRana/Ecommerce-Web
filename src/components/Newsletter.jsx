...
import Tree from "../assets/undertree.png"
const Newsletter = () => {
  return (
...
<div className='flex flex-col md:flex-row-reverse justify-between items-center gap-10'>
 {/* Banner image */}
 <div className='flex'>
    <img src={Tree} alt="" className='lg:h-[386px]' />
</div>
{/*Banner content */}
<div className='md:w-2/5'>
    <h2 className='md:text-7xl text-4xl font-bold text-white mb-6 leading-relaxed '>Between the pages of a book is a lovely place to be.</h2>
