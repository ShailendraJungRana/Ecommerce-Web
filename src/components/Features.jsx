      ...
      <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
        ...
        <div className='w-full lg:w-3/4 mt-4'>
          <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 items-start md:gap-12 gap-8'>
            <div className='card bg-white shadow-md rounded-[35px] overflow-hidden w-[260px] h-[280px] justify-center hover:-translate-y-4 transition-all duration-300 '>
              <img className='w-[148px] h-[130px] object-cover'  src={siting} alt=""/>
